  ...
  <div class="main_wrapper">
    <header>
      <div class="contacts_wrapper">
        <!-- _____________________________________________________first_block_________________________ -->
        <div class="first_block">
          ...
          <div class="btn_lang_wrapper">
            ...
            >
              ...
              <router-link v-if="headLangOpen" class="btn_lang_ua_open" to="/"
                >ru</router-link
              >
            </div>
          </div>
        ...
        <div class="second_block">
          <!--_____________________phones________________________ -->
    ...
    <div class="wrapper_all">
      <main>
          ...
          <div class="content_box_age">
            ...
            <div class="sub_content_box_age">
              ...
              >
                ...
                <p v-if="!b_one" class="btn_text">Записатися в групу</p>
        ...
        <div class="wrapper_contant">
          ...
          <div class="wrapper_for_methodology">
            <div class="header_methodology text_700_35">
              <h3>методика</h3>
            </div>
            ...
            <div class="text_header_methodology text_400_18">
              <span>
                Заняття проходять за ексклюзивною методикою мовного занурення
                 на трьох мовах - російською, українською та англійською і розділені на
                 блоки- дискусійні, гуманітарний, математичний і науковий.
                 Кожен блок включає в себе розвиток творчих здібностей
                 дитини - ліплення, малювання, розвиток дрібної і великої моторики,
                 сюжетно-рольові ігри, ігри на розвиток уяви.
              </span>
            </div>
            <!-- ________book_______________________________________________ -->
            <div class="wrap_book">
              <div class="book_">
                <img
                ...
                <img
                  ...
                  class="favicon_logo"
                />
                <span class="text_on_book text_700_35">English</span>
              </div>
              <div class="book_">
                <img
                  src="../../assets/img/img_png/book_ua.png"
                ...
                <img
                  ...
                  width="53"
                  height="58"
                  class="favicon_logo_ua"
                />
                <span class="text_on_book_center text_700_35">Українська</span>
              </div>
              <div class="book_">
                <img
                  src="../../assets/img/img_png/book_ua.png"
                ...
                <img
                  ...
                  class="favicon_logo"
                />
                <span class="text_on_book text_700_35">Русский</span>
              </div>
            </div>
          </div>

          <!-- ________group_____________________________менять_________________ -->
          <div class="wrapp_group">
          ...
          <div class="training_format_wrapper">
            ...
            <div class="class_format_text">
              <p>
                Працюємо <span class="text_b text_700_35">6 днів</span> в тиждень у
                (форматі - Полуднівка)
              </p>
            </div>
          ...
          <!-- __________________CIRCLE___CENTER___________________CIRCLE___CENTER_______________ -->
          <div class="wrap_center_circle">
            <div class="box_line_heading center_circle_header">
              <div class="heading_text center_circle_header_text">
                <h3>Наші переваги</h3>
              </div>
            </div>
            <!-- ___________________WRAP____CIRCLE_____________ -->
              ...
              <div class="central_circle">
                ...
                >
                  <p class="center_circ_bg_heading">
                    Хатинка - чітальня на трьох мовах
                  </p>
                  <span class="center_cercle_text">
                    Основою формування грамотної і красивої мови є читання.
                     Читання - це фундамент знань, завдяки якому у дитини 
                     формуються поняття про закони і правила, соціальних 
                     аспектів спілкування, баченню себе в єдиній зв'язці 
                     з навколишнім середовищем і людьми. На наших заняттях 
                     приділяється велика увага читання та обговорення прочитаного
                      на трьох мовах (російською, українською та англійською. 
                      У дітей закріплюються нейронні зв'язки, при яких мови 
                      не змішуються, а чітко розділені між собою. 
                      <br />
                    Дитина вчиться переказувати, висловлювати свою
                    думка, аргументувати і доводити свою точку зору, 
                    слухати співрозмовника і проявляти емпатію, ставити
                     себе на місце героїв книг і проектувати їх вчинки 
                     на себе, вмінню думати наперед, розвивати стратегічне мислення
                  </span>
                </div>
                ...
                >
                  <p class="center_circ_bg_heading">Підготовка до школи</p>
                  <p class="center_cercle_text text_two_circ">
                    Курс включає в себе різні види діяльності, які швидко змінюють один одного:
                  </p>
                  <div class="sub_center_cercle_text">
                    <span class="sub_cercle_text_one">
                      <span class="psevdo">
                        розвиток математичних навичок
                      </span>
                      <span class="psevdo"> завдання на логіку </span>
                      <span class="psevdo"> навчання читанню </span>
                      <span class="psevdo"> розвиток мовлення </span>
                      <span class="psevdo"> підготовка кисті до листа </span>
                      <span class="psevdo"> лист </span>
                      <span class="psevdo"> розвиток пам'яті </span>
                    </span>
                    <span class="sub_cercle_text">
                      <span class="psevdo"> пізнання навколишнього світу</span>
                      <span class="psevdo">ТРИЗ</span>
                      <span class="psevdo"> Українська мова </span>
                      <span class="psevdo">
                        застосування авторс методику заснованої на методиці Домана і кубиках Чаплигіна
                      </span>
                      <span class="psevdo"> англійська мова</span>
                    </span>
                  </div>
                </div>
                ...
                >
                  <p class="center_circ_bg_heading">Дозвілля першокласника</p>
                  <span class="center_cercle_text center_cercle_text_three">
                    Заняття проводяться на трьох мовах в ігровій формі. 
                    Основою є настільні та рухливі ігри, ігри на розвиток 
                    навичок конкурування і досягнення поставлених цілей.
                     Шляхом читання художньої та науково-пізнавальної літератури,
                      відбувається робота над формуванням мови, грамотного і послідовного 
                      викладу своїх думок. Допомога в навчанні читання і рахунку.
                       Навчання фінансової грамотності та навичкам формування сімейного 
                       бюджету.
                  </span>
                </div>
                <div
                ...
                >
                  ...
                  <span class="center_cercle_text center_cercle_text_four">
                    Гра-основний формат навчання дошкільнят.
                     Через гру відбувається соціалізація дітей, 
                     формування навичок спілкування, постановки мови, 
                     знайомство з буквами, цифрами і навколишнім світом. 
                     Наші заняття розділені на блоки і кожен блок включає в 
                     себе різні види ігор-на розвиток пам'яті та уваги, спритності
                      і фізичної активності, логіки і винахідливості, посидючість 
                      і вмінню слухати. Через гру ми формуємо навички, які дитина 
                      буде використовувати не тільки в школі, але і в житті.
                  </span>
                </div>
                <div
                ...
                >
                  <p class="center_circ_bg_heading">Реджіо педагогіка</p>
                  <span class="center_cercle_text"
                    >Головні принципи Реджіо-педагогіки: 
                    співпраця педагогів з дітьми, максимальна 
                    свобода Творчості і самовираження, уміння 
                    педагога бути на одному рівні з дитиною і ставитися
                     до дитини як до маленької особистості, поважати і
                      вислуховувати його думку, розвивати уяву. Педагог 
                      в нашій Академії - це друг, наставник і помічник. 
                      Та людина, яку цікавлять думка і думки дитини, який 
                      допоможе дитині самій знайти відповіді на всілякі «Чому?» 
                      і навіщо?" і реалізувати їх через творчість.
                  </span
                  >
                </div>
                ...
                >
                  <p class="center_circ_bg_heading">Відеоспостереження</p>
                  <span class="center_cercle_text center_cercle_text_six">
                    У нашій Академії знань ведеться цілодобове 
                    відеоспостереження. Це дає можливість батькам 
                    протягом перебування дитини в центрі бачити і
                     чути, що відбувається на заняттях. Кожному 
                     з батьків встановлюється на телефон додаток 
                     і він може в будь-який момент насолодитися чудовими 
                     і незабутніми моментами життя свою дитину, який проводить 
                     час в атмосфері творчості, знань та ігор на трьох мовах.
                  </span>
                </div>
                <div
                ...
                >
                  <p class="center_circ_bg_heading">Тріз</p>
                  <span class="center_cercle_text">
                    Теорія рішення винахідливих завдань - 
                    в процесі навчання відбувається розвиток 
                    творчого мислення (варіативності, диалектичности, 
                    системності); розвиток творчої уяви 
                    (оригінальності, гнучкості, продуктивності),
                     розвиток творчої мови (умінні придумувати
                      порівняння, загадки, історії), розвиток 
                      творчої особистості (прагнення до новизні, 
                      пошукової активності, допитливості) Завдяки
                       заняттям за методикою ТРІЗ, діти стають 
                       іншими: допитливими, винахідливими, балакучими, 
                       веселими і енергійними.
                  </span
                  >
                </div>
                ...
                >
                  <p class="center_circ_bg_heading">Фінансова грамотність</p>
                  <span class="center_cercle_text">
                    Успішність дорослого залежить від того, 
                    наскільки грамотно він вміє розпоряджатися 
                    грошима. Навчання фінансової грамотності 
                    необхідно починати якомога раніше, як тільки 
                    дитина навчитися здійснювати прості математичні 
                    розрахунки, орієнтовно з 5-6 років. На заняттях 
                    з фінансової грамотності наші викладачі в 
                    ігровій формі показують дитині як розпоряджатися
                     грошима, для чого вони потрібні, як відкладати і 
                     економити, як планувати бюджет.

                    Так само в основи фінансової грамотності 
                    входить курс «Професії», в якому діти знайомляться 
                    з різноманітними професіями, науками, які потрібно 
                    освоїти для тієї чи іншої професії і формують мотивацію 
                    для вивчення шкільних предметів в зв'язку з розумінням
                    їх застосування на практиці І в житті.
                  </span>
                </div>
                ...
                >
                  ...
                  <span class="center_cercle_text">
                    Посібники для проведення занять, 
                    представлені в трьох мовних форматах 
                    (українською, англійською та російською) 
                    і розроблені відповідно до Базового 
                    компоненту дошкільної освіти та системи НУШ, 
                    з урахуванням вікових норм дитини
                  </span>
                </div>
                ...
                >
                  <p class="center_circ_bg_heading">Мови</p>
                  <span class="center_cercle_text">
                    Навчання методом занурення на 
                    трьох мовах 36 годин англійської,
                     української та російської. Всі методичні 
                     посібники представлені у трьох мовах
                  </span>
                </div>
                <div
                ...
                >
                  <p class="center_circ_bg_heading">Творчість</p>
                  <span class="center_cercle_text">
                    Творчий процес є основним процесом, 
                    мотивуючи дитину до якоїсь дії, розвитку 
                    творчого потенціалу - оновне завдання наших 
                    педагогів. Заняття малюванням, ліпленням, 
                    аплікацією сприяє тренуванню кисті і стають 
                    підготовчим етапом до освоєння навичок письма, 
                    розвиває дрібну моторику і сприяє формуванню 
                    образного мислення і винахідливості. Так само під 
                    час занять педагог систематизує інформацію з 
                    прочитаного на Дискусійному блоці і мотивує дітей 
                    висловити це через творчий процес. Вивчення букв і 
                    цифр приносить дитині радість і задоволення і запам'
                    ятовується надовго, формуючи міцні нейронні зв'язки.
                  </span>
                </div>
                <div
                ...
                >
                  <p class="center_circ_bg_heading">
                    Малокомплектні групи до 8 осіб
                  </p>
                  <span class="center_cercle_text">
                    Заняття проходять в малокомплектній групі, 
                    що дозволяє приділити якісну увагу до кожної 
                    дитини, вислухати її думку, аргументи і доводи, 
                    вчасно скоригувати і допомогти дитині, якщо вона 
                    про це просить. Так само в малокомплектних групах 
                    дітки менше хворіють і мають можливість стабільно 
                    і довго, без пропусків, відвідувати наші заняття, 
                    що дозволяє сформувати стійкі знання і довготривалу пам'ять.
                  </span>
                </div>
              </div>
              ...
              <div class="small_circ_phome">
                ...
                >
                  <div class="content_small_circle sub_seven_circles">
                    ...
                    />
                    <p class="header_circles_seven text_near_circles">Тріз</p>
                  </div>
                </div>
              ...
              <div class="small_circ_phome">
                ...
                >
                  <div class="content_small_circle sub_ten_circles">
                    ...
                    />
                    <p class="header_circles_ten text_near_circles">Мови</p>
                  </div>
                </div>
              </div>
          ...
          <!-- _____________________OUR_RULES___________________________ -->

          <div class="wrap_our_rules">
            <div class="box_line_heading center_circle_rules">
              <div class="heading_text center_circle_header_rules">
                <h3>Правила нашої акадмії</h3>
              </div>
            </div>
            ...
            <div class="sub_wrap_gallery">
              <div class="box_line_heading center_circle_gallery">
                <div class="heading_text center_circle_header_gallery">
                  <h3>фото і відео нашого садка</h3>
                </div>
              </div>
              <div class="box_for_click">
                ...
                <swiper ref="gallerySwiper" class="swiper gallery_box">
                  <swiper-slide
                    class="gallery_box"
                    v-for="(chunk, index) in files"
                    :key="index"
                  >
        ...
        <div class="sub_wrap_footer">
          ...
          <div class="sticker_footer">
            ...
            <p class="sticker_footer_text">
              Приходьте до нас і ми з радістю поділимося своїми знаннями з вашими дітьми !
            </p>
          </div>
        </div>

        <div class="google_map_wrapper">
          <!-- _________________MAP_________________ -->
          <iframe
          ...
          <!-- ___________________STICKER__MAP______________ -->
...
export default {
  ...
  methods: {
    ...
    prevSlide() {
      this.$refs.gallerySwiper.$swiper.slidePrev();
    },
